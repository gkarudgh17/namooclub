    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse navbar-responsive-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="${ctx}/towner/logout.do">로그아웃 [ ${loginTowner.name} / ${loginTowner.email} ]</a></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">관리 <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="${ctx}/management/club.do">클럽 관리</a></li>
                        <li><a href="${ctx}/management/club.do">회원 관리</a></li>
                    </ul>
                </li>
                <li class="dropdown">
