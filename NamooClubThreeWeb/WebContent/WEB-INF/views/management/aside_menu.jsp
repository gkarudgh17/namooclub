...
<div style="z-index:1020" class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
    <div class="list-group panel panel-success">
        ...
        <div id="cat-navi">
            ...
            <a href="${ctx}/management/club/list.do?communityId=${communityId}" class="list-group-item <c:if test="${activeMenu=='club'}">active</c:if>">클럽관리</a>
            <a href="${ctx}/management/member/list.do?communityId=${communityId}" class="list-group-item <c:if test="${activeMenu=='member'}">active</c:if>">회원관리</a>
        </div>
