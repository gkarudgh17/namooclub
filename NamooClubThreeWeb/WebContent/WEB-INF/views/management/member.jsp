                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach var="member" items="${members}" varStatus="status">
                                  <tr>
                                      ...
                                      <td>${member.email}</td>
                                      <td class="text-center"><a href="#">${member.name}</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <c:if test="${member.authorized}">
                                              <a href="${ctx}/management/member.do?communityId=${communityId}&type=accept&email=${member.email}" class="btn btn-success btn-xs">가입승인</a>
                                              <a href="${ctx}/management/member.do?communityId=${communityId}&type=reject&email=${member.email}" class="btn btn-default btn-xs">가입거절</a>
                                            </c:if>
                                        </td>
                                    </tr>
                                  </c:if>
                                ...
                                <c:forEach var="member" items="${members}" varStatus="status"> 
                                  <c:if test="${member.state == 'RequestWithdrawal'}">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                          <c:if test="${member.authorized}">
                                            <a href="${ctx}/management/member.do?communityId=${communityId}&type=withdraw&email=${member.email}" class="btn btn-success btn-xs">탈퇴승인</a>
                                          </c:if>
                                        </td>
                                    </tr>
                                  </c:if>
