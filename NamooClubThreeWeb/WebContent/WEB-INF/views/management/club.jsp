                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach var="club" items="${clubs}" varStatus="status">
                                  <tr>
                                      ...
                                      <td>${club.category}</td>
                                      <td class="text-center"><a href="#">${club.name}</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <c:if test="${club.authorized}">
                                                <a href="${ctx}/management/club.do?communityId=${communityId}&type=accept&clubId=${club.id}" class="btn btn-success btn-xs">개설승인</a>
                                                <a href="${ctx}/management/club.do?communityId=${communityId}&type=reject&clubId=${club.id}" class="btn btn-default btn-xs">개설거절</a>
                                            </c:if>
                                        </td>
                                    </tr>
                                  </c:if>
                                ...
                                <c:forEach var="club" items="${clubs}" varStatus="status"> 
                                  <c:if test="${club.state == 'RequestClose'}">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                          <c:if test="${club.authorized}">
                                              <a href="${ctx}/management/club.do?communityId=${communityId}&type=close&clubId=${club.id}" class="btn btn-success btn-xs">폐쇄승인</a>
                                          </c:if>
                                        </td>
                                    </tr>
                                  </c:if>
