...
@WebServlet("/club/withdrawal/confirm.do")
@LoginRequired
public class ClubWithdrawalPageController extends DefaultController {
	//
	...
	protected void process(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String linkURL = "/club/withdrawal/process.do?communityId=" + communityId + "&clubId=" + clubId; 
