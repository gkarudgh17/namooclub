...
@LoginRequired
@WebServlet("/management/member/list.do")
public class MemberMgmtController extends MgmtDefaultController {
	//
	...
	protected void process(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (!StringUtil.isEmpty(type)) {
			...
			pageTranfer.redirectTo("/management/member/list.do?communityId=" + communityId);
			return;
		}
