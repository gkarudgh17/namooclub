...
@LoginRequired
@WebServlet("/management/club.do")
public class MgmtClubController extends MgmtDefaultController {
	//
	...
	protected void process(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (!StringUtil.isEmpty(type)) {
			...
			pageTranfer.redirectTo("/management/club.do?communityId=" + communityId);
			return;
		}
